// ═══════════════════════════════════════════════════════════════════════
// LAS VEGAS VALLEY TURF TRACKER — UI FRAMEWORK v36
// fix: replace broken TIGER/2020/PLACE with hardcoded place list
// ═══════════════════════════════════════════════════════════════════════
...
// // Delay place select so it runs after centerObject resolves
// ui.util.setTimeout(function() { placeSelect.setValue('Henderson', true); }, 1500);
