...
document.addEventListener("DOMContentLoaded", function () {
  ...
  links.forEach(function (link) {
    link.addEventListener("click", function (e) {
      ...
      if (target) {
        // THIS IS THE KEY FIX:
        // Quarto puts id on <section>, not <h2>. Find the actual heading inside.
        const heading = target.querySelector("h1, h2, h3, h4") || target;
        const OFFSET = 90;
        const pos = heading.getBoundingClientRect().top + window.pageYOffset - OFFSET;
