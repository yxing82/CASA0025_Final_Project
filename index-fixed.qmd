...
<div class="contributors-grid">
  <a href="https://github.com/yxing82" class="contributor-card">
    ...
    <p class="contributor-name">Yujing (Olivia) Xing</p>
    <p class="contributor-role">GEE App Architecture, UI/UX Design & Development, Concept Direction</p>
    <p class="contributor-github">github.com/yxing82</p>
  </a>
</div>
...
<div class="contributors-grid">
    ...
    <p class="contributor-name">Luke Benson</p>
    <p class="contributor-role">SMA/FVC Methodology, Vegetation Anlysis, Project Concept</p>
    <p class="contributor-github">github.com/lukegbenson</p>
  </a>
</div>
...
<div class="contributors-grid">
  <a href="https://github.com/casagochman" class="contributor-card">
    <div class="contributor-avatar" style="background:#7a8152;">Y</div>
    <p class="contributor-name">Yoav Gochman</p>
    <p class="contributor-role">LST Analysis, water consumption</p>
    <p class="contributor-github">github.com/casagochman</p>
  </a>
</div>
...
<div class="contributors-grid">
  <a href="https://github.com/christychoicc" class="contributor-card">
    ...
    <p class="contributor-name">Christy Choi</p>
    <p class="contributor-role">Preprocessing, GEE UI/UX design, Legend System, Documentation</p>
    <p class="contributor-github">github.com/christychoicc</p>
  </a>
</div>
...
<div class="contributors-grid">
  <a href="https://github.com/hawaiie-star" class="contributor-card">
    ...
    <p class="contributor-name">Waiie Tsang</p>
    <p class="contributor-role">Literature Review, Narrative Content</p>
    <p class="contributor-github">github.com/hawaiie-star</p>
  </a>
</div>
...
<div class="contributors-grid">
  <a href="https://github.com/Nanxi-lu" class="contributor-card">
    <div class="contributor-avatar" style="background:#7a8152;">L</div>
    <p class="contributor-name">Nanxi Lu</p>
    <p class="contributor-role">Literature Review, Narrative Content</p>
    <p class="contributor-github">github.com/Nanxi-lu</p>
  </a>
</div>
